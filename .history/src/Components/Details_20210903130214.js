...
export default class Details extends Component {
  ...
  render() {
    ...
    return (
      <>
        <section className="carousel" style={{ height: 600, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundImage: 'url(' + this.props.imageUrl + ')', backgroundPosition: 'center', position: 'relative' }}>
