          ...
          <div className="container">
            <div className="row">
              <div className="col col-md-3">
                ...
                <Link to={"/" + filmType + "/" + this.toSlug(filmDetailCurrent.title) + "/" + filmDetailCurrent.index + 1} style={{ width: '100%' }} className="btn btn-danger mt-3"><i className="fa fa-play" /> Xem phim</Link>
