...
class Details extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      let resp = await axios({
        url: "https://api.apify.com/v2/key-value-stores/QubTry45OOCkTyohU/records/LATESTh",
        method: "GET"
      })
      await this.setState({ dataFilm: resp.data, haveData: true });
      await this.getDataFilmCurrent()
  ...
  render() {
    const { filmDetailCurrent, database } = this.props;
            ...
            <div className="container">
              <div className="row">
                <div className="col col-md-3">
                  ...
                  <Link to={"/" + filmType + "/" + this.toSlug(filmDetailCurrent.title) + "/" + filmDetailCurrent.index + "/" + 0} style={{ width: '100%' }} className="btn btn-danger mt-3"><i className="fa fa-play" /> Xem phim</Link>
