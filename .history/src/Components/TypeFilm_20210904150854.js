      ...
      <div className="container">
        ...
        <nav aria-label="Page navigation example">
          <ul className="pagination ">
            ...
            <li className="page-item"><a className="btn btn-outline" href="/">1</a></li>
            <li className="page-item"><a className="btn btn-outline" href="/">2</a></li>
            <li className="page-item"><a className="btn btn-outline" href="/">3</a></li>
            <li className="page-item">
