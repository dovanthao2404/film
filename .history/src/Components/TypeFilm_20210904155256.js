        ...
        <nav aria-label="Page navigation example">
          <ul className="pagination justify-content-center">
            <li className="page-item mx-1">
              <button className="btn btn-outline" to={"/" + filmType} aria-label="Previous">
                <span aria-hidden="true">«</span>
              </button>
            </li>
            <li className="page-item mx-1"><button className="btn btn-outline" to={"/" + filmType}>1</button></li>
            <li className="page-item mx-1"><button className="btn btn-outline" to={"/" + filmType}>2</button></li>
            <li className="page-item mx-1"><button className="btn btn-outline" to={"/" + filmType}> .... </button></li>
            <li className="page-item mx-1">
              <button className="btn btn-outline" to={"/" + filmType} aria-label="Next">
                <span aria-hidden="true">»</span>
              </button>
            </li>
          </ul>
