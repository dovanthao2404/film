...
class Details extends Component {
  ...
  handleAddListFilmConnection = () => {
    ...
    for (let i = 0; i < LENGTH_CONNECTION; i++) {
      const nameCurrent = dataFilm.phim[filmDetailCurrent.type][i];
      if (this.toSlug(nameCurrent) !== name) {
        this.props.addFilmConnection(dataFilm.phim[filmDetailCurrent.type][i])
      } else {
        i--;
      }
    }
