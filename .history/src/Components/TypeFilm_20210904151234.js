        ...
        <nav aria-label="Page navigation example">
          <ul className="pagination justify-content-center">
            <li className="page-item mx-1">
              <a className="btn btn-outline" href={"/" + filmType} aria-label="Previous">
                <span aria-hidden="true">«</span>
              </a>
            </li>
            <li className="page-item mx-1"><a className="btn btn-outline" href={"/" + filmType}>1</a></li>
            <li className="page-item mx-1"><a className="btn btn-outline" href={"/" + filmType}>2</a></li>
            <li className="page-item mx-1"><a className="btn btn-outline" href={"/" + filmType}>3</a></li>
            <li className="page-item mx-1">
              <a className="btn btn-outline" href={"/" + filmType} aria-label="Next">
                <span aria-hidden="true">»</span>
              </a>
            </li>
          </ul>
