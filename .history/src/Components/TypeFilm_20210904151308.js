        ...
        <nav aria-label="Page navigation example">
          <ul className="pagination justify-content-center">
            <li className="page-item mx-1">
              <Link className="btn btn-outline" to={"/" + filmType} aria-label="Previous">
                <span aria-hidden="true">«</span>
              </Link>
            </li>
            <li className="page-item mx-1"><Link className="btn btn-outline" to={"/" + filmType}>1</Link></li>
            <li className="page-item mx-1"><Link className="btn btn-outline" to={"/" + filmType}>2</Link></li>
            <li className="page-item mx-1"><Link className="btn btn-outline" to={"/" + filmType}>3</Link></li>
            <li className="page-item mx-1">
              <Link className="btn btn-outline" to={"/" + filmType} aria-label="Next">
                <span aria-hidden="true">»</span>
              </Link>
            </li>
          </ul>
