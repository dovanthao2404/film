  ...
  handleRenderPwd = () => {
    if (this.state.haveData) {
      ...
      if (pwdPagination <= 4) {
        ...
        panigation.push(<li className="page-item mx-1"><button className="btn btn-outline" onClick={() => this.handleChangePwd(1)}>1</button></li>)
        panigation.push(<li className="mx-2">... </li>)
        panigation.push(<li className="mx-2">... </li>)
        panigation.push(<li className="page-item mx-1"><button className="btn btn-outline" onClick={() => this.handleChangePwd(totalPages)}>{totalPages}</button></li>)
      }
      return panigation;
    }
  }
