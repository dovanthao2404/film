              ...
              <div className="row">
                <div className="col col-md-3">
                  <div className>
                    ...
                    <button style={{ width: '100%' }} className="btn btn-danger mt-3"><i className="fa fa-play" /> Xem phim</button>
                  </div>
                </div>
                <div className="col col-md-9">
                  <h2 className="film-name">Snake Eyes: G.I. Joe Origins</h2>
                  <h4 className="author-name mb-4">G. I. Joe: Xà nhãn báo thù (2021)</h4>
                  <p className>2 giờ 1</p>
                  <div>
                    <button className="btn btn-primary"><i className="fab fa-facebook" /> Chia sẽ</button>
                    <button className="btn btn-success"><i className="fa fa-plus" /> Bộ sưu tập</button>
                  </div>
                </div>
              </div>
            </div></section>
