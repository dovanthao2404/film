...
class Pagination extends Component {
  ...
  handleRenderPwdMid = (panigation, pwdPagination, totalPages) => {
    panigation.push(
      <li key={1} className="page-item mx-1">
        <button
          className="btn btn-outline"
          onClick={() => this.handleChangePwd(1)}
        >
          1
        </button>
      </li>
    ...
    panigation.push(
      <li key={pwdPagination - 3} className="mx-2">
        ...{" "}
      </li>
    );

    panigation.push(
      <li key={pwdPagination - 2} className="page-item mx-1">
        <button
          className="btn btn-outline"
          onClick={() => this.handleChangePwd(pwdPagination - 2)}
        >
          {pwdPagination - 2}
        </button>
      </li>
    ...
    panigation.push(
      <li key={pwdPagination - 1} className="page-item mx-1">
        <button
          className="btn btn-outline"
          onClick={() => this.handleChangePwd(pwdPagination - 1)}
        >
          {pwdPagination - 1}
        </button>
      </li>
    ...
    panigation.push(
      <li key={pwdPagination} className="page-item mx-1">
        <button
          className="btn btn-outline active"
          onClick={() => this.handleChangePwd(pwdPagination)}
        >
          {pwdPagination}
        </button>
      </li>
    ...
    panigation.push(
      <li key={totalPages} className="page-item mx-1">
        <button
          className="btn btn-outline"
          onClick={() => this.handleChangePwd(totalPages)}
        >
          {totalPages}
        </button>
      </li>
  ...
  handleRenderPwd = (totalParam) => {
    ...
    if (database) {
      const totalFilm =
        totalParam || database.phim[typeFilm]?.length || this.totalFilm();
              ...
              if (i !== pwdPagination) {
                panigation.push(
                  <li key={i} className="page-item mx-1">
                    <button
                      className="btn btn-outline"
                      onClick={() => this.handleChangePwd(i)}
                    >
                      {i}
                    </button>
                  </li>
  ...
  render() {
    ...
    return <>{this.handleRenderPwd(listTypeFilmFilter.length)}</>;
  }
}
