  ...
  handleRenderPwd = () => {
    if (this.state.haveData) {
      ...
      if (pwdPagination <= 4) {
        ...
        panigation.push(<li key={new Date().getTime()} className="mx-2">... </li>)
        panigation.push(<li key={totalPages - 2} className="page-item mx-1"><button className="btn btn-outline" onClick={() => this.handleChangePwd(totalPages - 2)}>{totalPages - 2}</button></li>)
        panigation.push(<li key={totalPages - 1} className="page-item mx-1"><button className="btn btn-outline" onClick={() => this.handleChangePwd(totalPages - 1)}>{totalPages - 1}</button></li>)
