        ...
        for (let i = 0; i < dataFilm.phim[filmType].length; i++) {
          ...
          if (name === this.toSlug(filmCurrent.title)) {
            ...
            if (filmCurrent?.episode?.length > 0) {
              this.props.changeUrl(filmCurrent.episode[1].episode)
            } else {
          ...
          <div className="container">
            <div className="row">
              <div className="col col-md-3">
                ...
                <Link to={"/" + filmType + "/" + this.toSlug(filmDetailCurrent.title) + "/a"} style={{ width: '100%' }} className="btn btn-danger mt-3"><i className="fa fa-play" /> Xem phim</Link>
